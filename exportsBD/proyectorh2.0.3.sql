...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2025 a las 23:45:16
...
(1999, 63, 'Academico', '2025-05-26', '2025-05-26'),
(1999, 64, 'Día', '2025-05-26', '2025-05-27'),
(1999, 65, 'Financiera', '2025-05-27', '2025-05-27'),
(1999, 66, 'Financiera', '2025-05-27', '2025-05-27'),
(445, 67, 'Financiera', '2025-05-27', '2025-05-27'),
(1999, 68, 'Academico', '2025-05-27', NULL);
...
(10, 63, 'Academico', '2025-05-26'),
(0, 65, 'Financiera', '2025-05-27'),
(0, 66, 'Financiera', '2025-05-27'),
(0, 67, 'Financiera', '2025-05-27'),
(10, 68, 'Academico', NULL);
...
(63, '2025-05-26', '2025-05-26', 'Academico', 'Otorgada'),
(64, '2025-05-26', '2025-05-27', 'Día', 'Otorgada'),
(65, '2025-05-27', '2025-05-27', 'Financiera', 'Otorgada'),
(66, '2025-05-27', '2025-05-27', 'Financiera', 'Otorgada'),
(67, '2025-05-27', '2025-05-27', 'Financiera', 'Otorgada'),
(68, '2025-05-27', NULL, 'Academico', 'Pendiente');
...
(68, 1999, 10, 'Universidad', 'UTN', 'Exencion de inscripc');
...
(65, 1999, 0, 1, 0, 'Lentes'),
(66, 1999, 0, 1, 0, 'Guarderia'),
(67, 445, 0, 1, 0, 'Lentes');
...
(64, 1999, '2025-05-27', 0, 'Permiso sindical');
...
CREATE TABLE `tiposprestacion` (
  ...
  `PeriodoMeses` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tiposprestacion` (`id`, `tipoMayor`, `nombre`, `precio`, `PeriodoMeses`) VALUES
(1, 'Financiera', 'Guarderia', 1600, 12),
(2, 'Financiera', 'Lentes', 2000, NULL),
(7, 'Academica', 'Exencion de inscripc', 2000, NULL),
(8, 'Academica', 'Utiles', 1200, NULL),
(9, 'Academica', 'Tesis', 2000, NULL),
(10, 'Financiera', 'Gasto Funerario', 5000, NULL),
(11, 'Financiera', 'Aparato Ortopedico', 3000, NULL),
(12, 'Financiera', 'Canastilla mama', 1000, NULL),
(13, 'Financiera', 'Titulacion', 2000, NULL),
(14, 'Dia', 'Permiso sindical', 0, 0),
(15, 'Dia', 'Nacimiento hijo', 0, NULL),
(16, 'Dia', 'Otro', 0, NULL),
(17, 'Plazo', 'Incapacidad', 0, NULL),
(18, 'Plazo', 'Embarazo', 0, NULL),
(19, 'Plazo', 'Permiso por duelo', 0, NULL);
...
--
ALTER TABLE `prestacion`
  MODIFY `Id_Prestacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
